    ...
    return (
        <>
            ...
            {!isOpen && (
                <button
                    onClick={onToggle}
                    className="absolute bottom-6 right-6 z-50 p-4 bg-gradient-to-br from-brand-600 to-emerald-600 text-white rounded-2xl shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-300 flex items-center gap-2 group ring-4 ring-brand-500/10 dark:ring-brand-400/10"
                >
            ...
            {/* Sidebar Panel */}
            <div
                className={`absolute top-0 right-0 h-full bg-white dark:bg-gray-950 border-l border-gray-100 dark:border-gray-800/60 w-full sm:w-[400px] shadow-2xl transform transition-transform duration-300 ease-spring z-50 flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}
            >
                {/* Header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800/60 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-gradient-to-br from-brand-500 to-emerald-500 rounded-xl shadow-lg shadow-brand-500/20 text-white">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Powered by Workers AI</p>
                        </div>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 scroll-smooth custom-scrollbar">
                    {messages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-center p-6 space-y-6">
                            <div className="w-20 h-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-2xl flex items-center justify-center shadow-inner">
                            ...
                            <div className="grid grid-cols-1 gap-2 w-full max-w-xs">
                                <button onClick={() => onSendMessage("What are the key sustainability goals?")} className="text-sm py-3 px-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-md rounded-xl text-gray-600 dark:text-gray-300 transition-all font-medium text-left">
                                    Key sustainability goals
                                </button>
                                <button onClick={() => onSendMessage("Summarize the environmental risks")} className="text-sm py-3 px-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-md rounded-xl text-gray-600 dark:text-gray-300 transition-all font-medium text-left">
                                    Environmental risks
                                </button>
                            </div>
                        </div>
                            ...
                            >
                                <div
                                    className={`max-w-[85%] rounded-2xl px-5 py-3.5 shadow-sm ${msg.role === 'user'
                                        ? 'bg-gradient-to-br from-brand-600 to-emerald-600 text-white rounded-br-none shadow-brand-500/20'
                    ...
                    {isLoading && (
                        <div className="flex justify-start">
                            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl rounded-bl-none px-5 py-4 shadow-sm flex items-center gap-1.5">
                ...
                {/* Input Area */}
                <div className="p-4 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800/60">
                    <form onSubmit={handleSubmit} className="relative group">
                        ...
                        <button
                            ...
                            className="absolute right-2.5 bottom-2.5 p-2 bg-gradient-to-br from-brand-600 to-emerald-600 text-white rounded-lg hover:from-brand-700 hover:to-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg shadow-brand-500/20"
                        >
