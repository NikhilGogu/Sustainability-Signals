...
const features = [
  ...
  },
  {
    ...
    description: 'Track regulatory changes, disclosure requirements, and industry standards evolution.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Track ESG momentum, analyze company sustainability profiles, and make informed investment decisions with SustainabilitySignals." />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl animate-fade-up-delay-2">
              Track sustainability signals, analyze ESG momentum, and understand company profiles. Data-driven insights for responsible investing.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Comprehensive ESG monitoring across multiple dimensions
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-xl">
                  We're integrating institutional-grade data from Refinitiv and other leading providers. Currently showing demo data to showcase capabilities.
                </p>
              </div>
      ...
      <section className="py-20 bg-brand-600 animate-shimmer">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-brand-100 max-w-2xl mx-auto mb-8">
            See how SustainabilitySignals presents ESG data. Browse mock signals, analyze sector performance, and explore company profiles.
          </p>
